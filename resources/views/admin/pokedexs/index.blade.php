...
<div class="col-6 mx-auto border-top border-end border-start">
  ...
  <a href="{{ route('pokedexs.create') }}" class="btn btn-primary m-3">
  ...
  @foreach ($pokedexs as $pokedex)
    <tr>
      <td>
        <span class="fs-5">{{ $pokedex->nombre }}</span>
      </td>
      <td>
        <a href="{{ route('pokedexs.show', ['pokedex' => $pokedex->id]) }}" type="submit" class="btn btn-success btn-sm">Editar</a>
      </td>
      <td>
