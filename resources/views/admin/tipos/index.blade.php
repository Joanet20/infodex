...
<div class="col-6 mx-auto border-top border-end border-start">
  ...
  <a href="{{ route('tipos.create') }}" class="btn btn-primary m-3">
  ...
  @foreach ($tipos as $tipo)
    <tr>
      <td>
        <span class="fs-5">{{ $tipo->nombre }}</span>
      </td>
      <td>
        <a href="{{ route('tipos.show', ['tipo' => $tipo->id]) }}" type="submit" class="btn btn-success btn-sm">Editar</a>
      </td>
      <td>
