...
<div class="col-6 mx-auto border-top border-end border-start">
  ...
  <a href="{{ route('regiones.create') }}" class="btn btn-primary m-3">
  ...
  @foreach ($regiones as $region)
    <tr>
      <td>
        <span class="fs-5">{{ $region->nombre }}</span>
      </td>
      <td>
        <a href="{{ route('regiones.show', ['regione' => $region->id]) }}" type="submit" class="btn btn-success btn-sm">Editar</a>
      </td>
      <td>
